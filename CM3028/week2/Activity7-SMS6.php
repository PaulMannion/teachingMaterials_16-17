 ...
 * Date: 27/10/15
 * Time: 17:07
 * All previous attempts at specs, mugs and sausage roll control in Aberdeen have failed. It has been decided that a lottery should be run in order to finally (we hope) decide who will get all of the specs, all of the mugs, and all of the sausage rolls. This will hopefully keep everyone happy and end these terrible terrible puns.
